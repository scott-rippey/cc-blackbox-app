...
Local macOS IDE + agent harness for Claude Code: workspace, editor, terminals,
...
4. In the app: Settings → Install hooks (required for session recording).
...
Requires an Apple Silicon Mac on a recent macOS, plus the
...
this repository hosts installers and release notes only.
